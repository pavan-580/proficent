( function( $ ) {
    ...
    * --------------------------------------------------*/
    ...
    $('.header-static .is-fixed').parent().append('<div class="header-clone"></div>');
$('.header-clone').height($('.octf-main-header.is-fixed').outerHeight());
$('.header-static .header-clone').hide();

$(window).on("scroll", function(){
    var site_header = $('.octf-main-header').outerHeight() + 1; // Adjusted selector for your header
    var logo = $('#site-logo img'); // Correctly select the logo image element

    if ($(window).scrollTop() >= site_header) {
        $('.octf-main-header.is-fixed').addClass('is-stuck');
        $('.header-static .header-clone').show();

        // Change the image when scrolled
        logo.attr('src', 'images/logo-footer.svg');
    } else {
        $('.octf-main-header.is-fixed').removeClass('is-stuck');
        $('.header-static .header-clone').hide();

        // Revert the image when not scrolled
...
// $(window).on("scroll", function(){
//     var site_header = $('#site-header').outerHeight() + 1;
//     var logo = $('#navbar-logo'); // Select your logo image element
